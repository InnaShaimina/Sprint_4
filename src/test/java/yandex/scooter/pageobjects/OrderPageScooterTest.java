...
public class OrderPageScooterTest {
    ...
    public OrderPageScooterTest(String name, String surname, String address, String subwayStation, String phoneNumber, String dateOfOrderArrival, String longivityOfOrderArrival)
    {
        this.name = name;
    ...
    //тест, проверяющий заказ через кнопку в хедере (Chrome)
    @Test
    ...
    //тест, проверяющий заказ через кнопку в хедере (Firefox)
    @Test
    public void orderPageScooterButtonHeaderPositiveTestFirefox() {
    ...
    //тест, проверяющий заказ через кнопку на Главной (Chrome)
    @Test
    ...
    //тест, проверяющий заказ через кнопку на Главной (Firefox)
    @Test
    public void orderPageScooterButtonMainPositiveTestFirefox() {
        WebDriverManager.firefoxdriver().setup();
        driver = new FirefoxDriver();
        driver.get("https://qa-scooter.praktikum-services.ru/");
        HomePageScooter objLoginPage = new HomePageScooter(driver);
