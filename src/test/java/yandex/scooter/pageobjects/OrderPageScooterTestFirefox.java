...
public class OrderPageScooterTestFirefox extends TestBaseFirefox{
    ...
    public OrderPageScooterTestFirefox(String name, String surname, String address, String subwayStation, String phoneNumber, String dateOfOrderArrival, String longivityOfOrderArrival)
    {
        this.name = name;
    ...
    //positive тест, проверяющий заказ через кнопку на Главной (Firefox)
    @Test
    ...
    //positive тест, проверяющий заказ через кнопку в хедере (Firefox)
    @Test
